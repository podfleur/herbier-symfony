 ...
 */
final class Version20240106233608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE releve (id INT AUTO_INCREMENT NOT NULL, lieu_id INT NOT NULL, date DATE NOT NULL, releve_brut VARCHAR(17) NOT NULL, INDEX IDX_DDABFF836AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
